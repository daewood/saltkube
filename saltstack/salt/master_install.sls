...
{% set source_hash4 = salt['cmd.shell']('echo "md5=`curl -s -L "https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kube-apiserver" | md5sum | cut -c -32`"') %}
{% set source_hash5 = salt['cmd.shell']('echo "md5=`curl -s -L "https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kube-controller-manager" | md5sum | cut -c -32`"') %}
{% set source_hash6 = salt['cmd.shell']('echo "md5=`curl -s -L "https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kube-scheduler" | md5sum | cut -c -32`"') %}
{% set source_hash7 = salt['cmd.shell']('echo "md5=`curl -s -L "https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kubectl" | md5sum | cut -c -32`"') %}
...
k8s_apiserver_binary:
  file.managed:
    ...
    - source: https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kube-apiserver
    - mode: 755
...
k8s_controller_binary:
  file.managed:
    ...
    - source: https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kube-controller-manager
    - mode: 755
...
k8s_scheduler_binary:
  file.managed:
    ...
    - source: https://storage.googleapis.com/kubernetes-release/release/v1.8.4/bin/linux/amd64/kube-scheduler
    - mode: 755
